...
Om het resultaat hiervan te zien, moeten we ook een methode `get_pokemon_by_name` voorzien die een pokemon naam als argument neemt, en het geassocieerde Pokemon object teruggeeft:

```python
>>> bulbasaur = pokedex.get_pokemon_by_name("Bulbasaur")
>>> bulbasaur.name
"Bulbasaur"
>>> bulbasaur.type
"Grass-Poison"
...
>>> pidgey = pokedex.get_pokemon_by_name("Pidgey")
>>> pidgey.name_found
True
>>> pidgey.type_found
False
...
```python
>>> rattata = pokedex.get_pokemon_by_name("Rattata")
...
>>> raticate = pokedex.get_pokemon_by_name("Raticate")
...
>>> spearow = pokedex.get_pokemon_by_name("Spearow")
